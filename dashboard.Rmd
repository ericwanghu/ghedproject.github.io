...
undeveloped_nations <-ghed_df%>%
  filter(country!="Canada" & country!="Japan"& country!="Republic of Korea"& country!="France" & country!="Germany"& country!="Italy"& country!="United Kingdom"& country!="United States of America", year == 2019)
```
