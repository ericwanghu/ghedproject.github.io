...
The figure above shows the distribution of income levels of countries (categorized in 2019) in each WHO region: AFR, AMR, EMR, EUR, SEAR, and WPR. \
...
As we can see from the above line plots, among these developing economies, Argentina has the highest total and government spending per capita over time and grows at a steeper rate year over year than the other countries. According to an
**[Economist article](https://solidfoundations.economist.com/reports/Amgen_Argentina_English_Final.pdf)**, Argentina's government has been devoting more resources to healthcare over the years to address healthcare inequalities. Some of the African countries, such as Senegal, South Africa, and Uganda, don't seem to have increased health spending much, if at all, over the last two decades. \
